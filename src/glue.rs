...
pub struct ProxyTraps {
    ...
    pub getPropertyDescriptor: Option<extern "C" fn(*mut JSContext, JSHandleObject, JSHandleId, MutableHandle<JSPropertyDescriptor>, u32) -> bool>,
    pub getOwnPropertyDescriptor: Option<extern "C" fn(*mut JSContext, JSHandleObject, JSHandleId, MutableHandle<JSPropertyDescriptor>, u32) -> bool>,
    ...
    pub call: Option<extern "C" fn(*mut JSContext, JSHandleObject, uint, JSMutableHandleValue) -> bool>,
